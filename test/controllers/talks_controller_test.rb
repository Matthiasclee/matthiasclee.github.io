...
class TalksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post talks_url, params: { talk: { date: @talk.date, download: @talk.download, location: @talk.location, name: @talk.name, website: @talk.website } }
    end
  ...
  test "should update talk" do
    patch talk_url(@talk), params: { talk: { date: @talk.date, download: @talk.download, location: @talk.location, name: @talk.name, website: @talk.website } }
